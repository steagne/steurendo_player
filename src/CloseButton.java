...
public class CloseButton extends AbstractButton
{
	...
	private static final Color COLOR_OVER = new Color(255, 0, 0, 200);
	private static final Color COLOR_PRESSED = new Color(255, 0, 0, 250);
	...
	public void paintComponent(Graphics g)
	{
		...
		y1 = (getHeight() / 2 - iconSize / 2);
		x2 = (getWidth() / 2 + iconSize / 2);
		y2 = (getHeight() / 2 + iconSize / 2);
